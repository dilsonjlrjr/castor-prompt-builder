...
habilidades:
  ...
  - Async/await com asyncio, aiohttp, httpx, trio; event loop internals
  ...
  - Testing: pytest avançado (fixtures, parametrize, plugins), unittest.mock,
    hypothesis (property-based), pytest-asyncio, Testcontainers, factory_boy
  ...
  - Performance: profiling com cProfile/py-spy, memory_profiler, Cython, Rust
    extensions com PyO3, multiprocessing vs threading vs asyncio trade-offs
